...
iconCart.addEventListener('click', function(){
    if(cart.style.right == '-100%'){
        ...
        contact.style.transform = 'translateX(-320px)'
        heading.style.transform = 'translateX(-320px)'
        home.style.transform = 'translateX(-400px)'
        listProduct.style.transform = 'translateX(-320px)';
    }else{
